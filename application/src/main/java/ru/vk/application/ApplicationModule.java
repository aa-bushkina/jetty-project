...
public class ApplicationModule extends AbstractModule {
  ...
  protected void configure() {
    final DBProperties properties = new DBProperties(args[0], args[1], args[2], args[3]);
    ...
    //bind(ProductREST.class).toInstance(new ProductREST(new ProductDAO(properties), new OrganizationDAO(properties)));
  }
